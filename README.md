...
![Bitcoin](https://img.shields.io/badge/₿-Bitcoin-f7931a)
![Ethereum](https://img.shields.io/badge/Ξ-Ethereum-627eea)
![Solana](https://img.shields.io/badge/◎-Solana-14f195)
![Dogecoin](https://img.shields.io/badge/Ð-Dogecoin-c2a633)
![Blockchain](https://img.shields.io/badge/⛓-blockchain-555555)
...
Bitcoin's genesis block is dated **January 3, 2009**, so the history of crypto-in-rap is short enough to actually map. This repo traces that arc: from cypherpunk novelty rap (**YTCracker, 2013**), to a stray bar on an underground classic (**Action Bronson, 2014**), to a 2018 gold rush, all the way to **Drake, Kendrick, Nas & Premier, and Baby Keem** putting Bitcoin, Ethereum, and Solana on chart records.

The rule: **if a lyric is in this repo, its exact wording was confirmed against a citable source.** Nothing here is from memory.
...
- [💼 Crypto-rich, but no bars](#-crypto-rich-but-no-bars)
...
| | |
|---|---|
| 🥇 **First crypto bar found** | YTCracker — *Bitcoin Baron* (**2013**) |
| Ξ **Only Ethereum reference** | Nas & DJ Premier — *GiT Ready*: *"Turn Ether to Etherium, y'all wanna bet?"* |
| ◎ **Only Solana reference** | Baby Keem — *Ca$ino*: *"She got a man, so I hold like Solana"* |
| 🧠 **Satoshi name-drops** | Gramatik (*Satoshi Nakamoto*) · Lil Windex (*Bitcoin Ca$h*) |
| 🎯 **Sharpest line** | billy woods: *"For every Jack Harlow, it's a white boy who didn't make it / And works in crypto and intellectual property"* |

## 📜 The catalog

> **Legend** — coins: ₿ Bitcoin/BTC · Ξ Ethereum · ◎ Solana · Ð Dogecoin · ⛓ blockchain · 🪙 "crypto"/cryptocurrency.
> Links: 🔍 = Genius search · ▶ = YouTube/audio. Confidence: **H** = lyric confirmed on a strong source · **M** = single source / search snippets. `(partial)` = fewer than ~4 contiguous bars could be sourced.

| # | Artist | Song | Year | Coin(s) | ~4-bar excerpt | 🔍 | ▶ | |
|---|---|---|---|---|---|---|---|---|
| 1 | **YTCracker** | Bitcoin Baron | 2013 | ₿ ⛓ | You know rappers like to rock chains<br>I rock blockchains, knock 'em out the box off Mount Gox, mang<br>[…]<br>I'm a bitcoin baron, I'm scaring the status quo<br>Got that crypto dough in that .dat file to blow *(partial)* | [🔍](https://genius.com/search?q=YTCracker%20Bitcoin%20Baron) | [▶](https://www.youtube.com/watch?v=fZfg1Gtcg08) | H |
| 2 | **Action Bronson** | Knicks (Remix) *(Freddie Gibbs & Madlib)* | 2014 | ₿ | I'm not the one for all the small talk<br>I'm like Christopher Lloyd, Big Noyd<br>Bitcoins, rosemary on the strip loin<br>Mike Tyson doin' endos on a Haro | [🔍](https://genius.com/search?q=Freddie%20Gibbs%20Madlib%20Knicks%20Remix) | [▶](https://www.youtube.com/watch?v=xdcBfj_EBuU) | H |
| 3 | **Gramatik** *(ft. ProbCause)* | Satoshi Nakamoto | 2016 | ₿ 🧠 | Stack a couple bit coins<br>All up on my Nakamoto<br>Chillin' with your lady friend<br>She rockin' an untied kimono *(producer track, rapped verse)* | [🔍](https://genius.com/search?q=Gramatik%20Satoshi%20Nakamoto) | [▶](https://www.youtube.com/watch?v=HAwC0swp96I) | M |
| 4 | **Eminem** *(Royce da 5'9")* | Not Alike | 2018 | ₿ | 'Member everybody used to bite Nickel?<br>Now everybody doin' Bitcoin *(partial — Royce's verse)* | [🔍](https://genius.com/search?q=Eminem%20Not%20Alike) | [▶](https://www.youtube.com/watch?v=U_zXqSEAcxI) | H |
| 5 | **Soulja Boy** | Bitcoin | 2018 | ₿ | I made 100 racks off of bitcoin<br>You can catch me trappin' with the bitcoin<br>You can catch me runnin' up the bitcoin<br>I spent 6,000 on the bitcoin | [🔍](https://genius.com/search?q=Soulja%20Boy%20Bitcoin) | [▶](https://www.youtube.com/watch?v=j2ZgmCqWfOw) | H |
| 6 | **Big Sean** *(on YG's "Big Bank")* | Big Bank | 2018 | 🪙 | I turn my Ws to Ms, yeah I flip those<br>I might buy her red bottoms with the crypto<br>Three coins, that'll pay ya whole semester<br>But you gotta ride it better than a Tesla | [🔍](https://genius.com/search?q=YG%20Big%20Bank) | [▶](https://www.youtube.com/watch?v=NNkEmouO_GI) | H |
| 7 | **Mick Jenkins** | Gwendolynn's Apprehension | 2018 | ₿ ⛓ | Quit that, got a better chance with Bitcoin<br>Big banks see you stuntin' and this shit's deep<br>Crypt keep and now you're fuckin' with the blockchain *(partial)* | [🔍](https://genius.com/search?q=Mick%20Jenkins%20Gwendolynn%27s%20Apprehension) | [▶](https://www.youtube.com/watch?v=wMXt0ku0C8g) | H |
| 8 | **Coindaddy** | Holding the Bag | 2018 | ₿ | If you want the ride and you want the riches then just buy more coin and get the bitches<br>'Cause bitcoin 'bout to go straight through the roof, it's got the PBOC shakin' in their boots *(partial)* | [🔍](https://genius.com/search?q=Coindaddy%20Holding%20the%20Bag) | [▶](https://www.youtube.com/watch?v=Gj5zBD0PISU) | H |
| 9 | **Lil Windex** | Bitcoin Ca$h | 2018 | ₿ 🧠 | The miners make money by takin' a fee every time a transaction is made and complete<br>And they work every minute and day of the week<br>A guy named Satoshi created this all<br>He's the mastermind of it *(partial)* | [🔍](https://genius.com/search?q=Lil%20Windex%20Bitcoin%20Cash) | [▶](https://www.youtube.com/watch?v=JFHTLe4LUeQ) | M |
| 10 | **Rick Ross** *(ft. John Legend & Lil Wayne)* | Maybach Music VI | 2019 | 🪙 | Money overboard, kilos washin' ashore<br>Paintings on the wall, Versace down to the drawers<br>Currency come in crypto, you know they tapin' our calls *(partial)* | [🔍](https://genius.com/search?q=Rick%20Ross%20Maybach%20Music%20VI) | [▶](https://www.youtube.com/watch?v=J0EEHE79EtA) | H |
| 11 | **Nas** *(on DJ Khaled's "Sorry Not Sorry")* | Sorry Not Sorry | 2021 | 🪙 | Winner in life, fuck a coin toss<br>I'm Coinbased, basically cryptocurrency Scarface *(partial)* | [🔍](https://genius.com/search?q=DJ%20Khaled%20Sorry%20Not%20Sorry) | [▶](https://www.youtube.com/watch?v=mON6_EQfQFI) | H |
...
| Ξ **Ethereum** | 1 | Nas & DJ Premier (*GiT Ready*) |
| ◎ **Solana** | 1 | Baby Keem (*Ca$ino*) |

*Also name-checked:* litecoin, Bitcoin Cash, Zcash, TON/Toncoin, Coinbase, Robinhood, Mt. Gox.

> **Bitcoin still dominates the bars.** Ethereum and Solana each appear exactly once — both within the last year. If you find another, it's the most valuable thing you can add.
...
## 💼 Crypto-rich, but no bars

Plenty of artists are deep in crypto as **investors or businesspeople** but have no in-lyric reference — owning the bag isn't the same as putting it in a bar, and this catalog only counts the bars:

> **Jay-Z** (Bitcoin Academy) · **50 Cent** (sold *Animal Ambition* for BTC) · **Megan Thee Stallion** (#BitcoinMeg) · **Logic** ($6M BTC) · **Jim Jones** (Capo Coin) · **DDG** · **Gunna** (PushinPETH) · **2 Chainz** · **Cardi B** · **Kanye West** · **Kodak Black** ($YAK) · **Lil Durk** (song-ownership NFTs)
...
- `(partial)` marks excerpts where fewer than ~4 contiguous bars could be sourced. Lines are quoted as the source rendered them, profanity and all.
...
Spotted a missing bar, a wrong link, or a fix? **[Open an issue](../../issues)** or a PR. One rule, mirroring how this repo was built:

> **Include a source** — a link where the lyric can be confirmed verbatim. No sourceless additions.

---

<div align="center">

<sub>Lyric excerpts are reproduced in short, transformative form for commentary and cultural documentation (fair use). All lyrics remain the property of their respective artists and rights holders. Non-commercial reference project.</sub>
